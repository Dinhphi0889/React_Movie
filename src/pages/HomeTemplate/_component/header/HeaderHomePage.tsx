        ...
        <div className="container">
          ...
          >
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              {/* Render button đăng nhập */}
              <form onSubmit={hanleSubmit} className="form-inline my-2 my-lg-0">
                {isLogin
                  ? (
                    <div className="dropdown"
                    >
                      <button className="btn btn-success" data-toggle="dropdown" aria-expanded="false"
                        style={{
                          borderRadius: '50%',
                          fontSize: '22px',
                          color: 'white',
                      ...
                      <div className="dropdown-menu">
                        <a className="dropdown-item" href="#">Thông tin tài khoản </a>
                        <a className="dropdown-item" href="#">Đăng xuất</a>
                      </div>
                    </div>
                  )
                  : (<div><button
